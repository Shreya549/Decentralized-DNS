function getReceipt() {
  if (sessionStorage.getItem("TxReceipt") === null) {
    ...
    $("#receiptHeader").append(
      `<a style="font-size:15px; color: white; font-weight:700" onMouseOut="this.style.color='white'" onMouseOver="this.style.color='blue'" href="https://ropsten.etherscan.io/tx/${tx.transactionHash}" target = "_blank">Verify Transaction on EtherScan</a>`
    );
